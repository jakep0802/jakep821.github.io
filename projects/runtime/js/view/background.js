var background = function (window) {
    ...
    window.opspark.makeBackground = function(app,ground) {
        ...
        function update() {
            ...
            chipOne.x = chipOne.x - 0.7;
            chipTwo.x = chipTwo.x - 0.7;
            chipThree.x = chipThree.x - 0.7;
            chipFour.x = chipFour.x - 0.7;
            chipFive.x = chipFive.x - 0.7;
            
            cornerOnePartOne.x = cornerOnePartOne.x - 0.7;
            cornerOnePartTwo.x = cornerOnePartTwo.x - 0.7;
            
            boxOnePartOne.x = boxOnePartTwo.x - 0.7;
            boxOnePartTwo.x = boxOnePartTwo.x - 0.7;
            boxOnePartThree.x = boxOnePartThree.x - 0.7;
            boxTwoPartOne.x = boxTwoPartOne.x - 0.7;
            boxTwoPartTwo.x = boxTwoPartTwo.x - 0.7;
            boxTwoPartThree.x = boxTwoPartThree.x - 0.7;
            boxThree.x = boxThree.x - 0.7;
            boxFourPartOne.x = boxFourPartOne.x - 0.7;
            boxFourPartTwo.x = boxFourPartTwo.x - 0.7;
            boxFourPartThree.x = boxFourPartThree.x - 0.7;
            boxFivePartOne.x = boxFivePartOne.x - 0.7;
            boxFivePartTwo.x = boxFivePartTwo.x - 0.7;
            boxFivePartThree.x = boxFivePartThree.x - 0.7;
            boxSixPartOne.x = boxSixPartOne.x - 0.7;
            boxSixPartTwo.x = boxSixPartTwo.x - 0.7;
            boxSixPartThree.x = boxSixPartThree.x - 0.7;
            boxSevenPartOne.x = boxSevenPartOne.x - 0.7;
            boxSevenPartTwo.x = boxSevenPartTwo.x - 0.7;
            boxSevenPartThree.x = boxSevenPartThree.x - 0.7;
            boxEight.x = boxEight.x - 0.7;
            boxNine.x = boxNine.x - 0.7;
            
            lineOnePartOne.x = lineOnePartOne.x - 0.7;
            lineOnePartTwo.x = lineOnePartTwo.x - 0.7;
            lineOnePartThree.x = lineOnePartThree.x - 0.7;
            lineTwoPartOne.x = lineTwoPartOne.x - 0.7;
            lineTwoPartTwo.x = lineTwoPartTwo.x - 0.7;
            lineTwoPartThree.x = lineTwoPartThree.x - 0.7;
            lineThreePartOne.x = lineThreePartOne.x - 0.7;
            lineThreePartTwo.x = lineThreePartTwo.x - 0.7;
            lineThreePartThree.x = lineThreePartThree.x - 0.7;
            lineFourPartOne.x = lineFourPartOne.x - 0.7;
            lineFourPartTwo.x = lineFourPartTwo.x - 0.7;
            lineFourPartThree.x = lineFourPartThree.x - 0.7;
            lineFivePartOne.x = lineFivePartOne.x - 0.7;
            lineFivePartTwo.x = lineFivePartTwo.x - 0.7;
            lineFivePartThree.x = lineFivePartThree.x - 0.7;
            lineFivePartFour.x = lineFivePartFour.x - 0.7;
            lineFivePartFive.x = lineFivePartFive.x - 0.7;
            lineSixPartOne.x = lineSixPartOne.x - 0.7;
            lineSixPartTwo.x = lineSixPartTwo.x - 0.7;
            lineSixPartThree.x = lineSixPartThree.x - 0.7;
            lineSeven.x = lineSeven.x - 0.7;
            lineEight.x = lineEight.x - 0.7;
            lineNinePartOne.x = lineNinePartOne.x - 0.7;
            lineNinePartTwo.x = lineNinePartTwo.x - 0.7;
            lineNinePartThree.x = lineNinePartThree.x - 0.7;
            lineTenPartOne.x = lineTenPartOne.x - 0.7;
            lineTenPartTwo.x = lineTenPartTwo.x - 0.7;
            lineTenPartThree.x = lineTenPartThree.x - 0.7;
            lineEleven.x = lineEleven.x - 0.7;
            lineTwelvePartOne.x = lineTwelvePartOne.x - 0.7;
            lineTwelvePartTwo.x = lineTwelvePartTwo.x - 0.7;
            lineTwelvePartThree.x = lineTwelvePartThree.x - 0.7;
            lineThirteenPartOne.x = lineThirteenPartOne.x - 0.7;
            lineThirteenPartTwo.x = lineThirteenPartTwo.x - 0.7;
            lineThirteenPartThree.x = lineThirteenPartThree.x - 0.7;
            lineFourteenPartOne.x = lineFourteenPartOne.x - 0.7;
            lineFourteenPartTwo.x = lineFourteenPartTwo.x - 0.7;
            lineFourteenPartThree.x = lineFourteenPartThree.x - 0.7;
            lineFifteenPartOne.x = lineFifteenPartOne.x - 0.7;
            lineFifteenPartTwo.x = lineFifteenPartTwo.x - 0.7;
            lineFifteenPartThree.x = lineFifteenPartThree.x - 0.7;
            line16PartOne.x = line16PartOne.x - 0.7;
            line16PartTwo.x = line16PartTwo.x - 0.7;
            line16PartThree.x = line16PartThree.x - 0.7;
            line17PartOne.x = line17PartOne.x - 0.7;
            line17PartTwo.x = line17PartTwo.x - 0.7;
            line17PartThree.x = line17PartThree.x - 0.7;
            line18PartOne.x = line18PartOne.x - 0.7;
            line18PartTwo.x = line18PartTwo.x - 0.7;
            line18PartThree.x = line18PartThree.x - 0.7;
            line19PartOne.x = line19PartOne.x - 0.7;
            line19PartTwo.x = line19PartTwo.x - 0.7;
            line19PartThree.x = line19PartThree.x - 0.7;
            lineTwentyPartOne.x = lineTwentyPartOne.x - 0.7;
            lineTwentyPartTwo.x = lineTwentyPartTwo.x - 0.7;
            lineTwentyPartThree.x = lineTwentyPartThree.x - 0.7;
            lineTwentyOne.x = lineTwentyOne.x - 0.7;
            lineTwentyTwo.x = lineTwentyTwo.x - 0.7;
            lineTwentyThree.x = lineTwentyThree.x - 0.7;
            
            slotOneBorder.x = slotOneBorder.x - 0.7;
            slotOnePort.x = slotOnePort.x - 0.7;
            slotTwoBorder.x = slotTwoBorder.x - 0.7;
            slotTwoPort.x = slotTwoPort.x - 0.7;
            slotThreeBorder.x = slotThreeBorder.x - 0.7;
            slotThreePort.x = slotThreePort.x - 0.7;
            slotFourBorder.x = slotFourBorder.x - 0.7;
            slotFourPort.x = slotFourPort.x - 0.7;
            slotFiveBorder.x = slotFiveBorder.x - 0.7;
            slotFivePort.x = slotFivePort.x - 0.7;
            slotSixBorder.x = slotSixBorder.x - 0.7;
            slotSixPort.x = slotSixPort.x - 0.7;
            slotSevenBorder.x = slotSevenBorder.x - 0.7;
            slotSevenPort.x = slotSevenPort.x - 0.7;
            slotEightBorder.x = slotEightBorder.x - 0.7;
            slotEightPort.x = slotEightPort.x - 0.7;
            slotNineBorder.x = slotNineBorder.x - 0.7;
            slotNinePort.x = slotNinePort.x - 0.7;
            slotTenBorder.x = slotTenBorder.x - 0.7;
            slotTenPort.x = slotTenPort.x - 0.7;
            slotElevenBorder.x = slotElevenBorder.x - 0.7;
            slotElevenPort.x = slotElevenPort.x - 0.7;
            
            ramSlotOne.x = ramSlotOne.x - 0.7;
            ramPortOne.x = ramPortOne.x - 0.7;
            ramSlotTwo.x = ramSlotTwo.x - 0.7;
            ramPortTwo.x = ramPortTwo.x - 0.7;
