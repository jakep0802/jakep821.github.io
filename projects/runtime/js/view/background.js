var background = function (window) {
    ...
    window.opspark.makeBackground = function(app,ground) {
        ...
        function update() {
            ...
            chipOne.x = chipOne.x - 0.5;
            chipTwo.x = chipTwo.x - 0.5;
            chipThree.x = chipThree.x - 0.5;
            chipFour.x = chipFour.x - 0.5;
            chipFive.x = chipFive.x - 0.5;
            
            cornerOnePartOne.x = cornerOnePartOne.x - 0.5;
            cornerOnePartTwo.x = cornerOnePartTwo.x - 0.5;
            
            boxOnePartOne.x = boxOnePartTwo.x - 0.5;
            boxOnePartTwo.x = boxOnePartTwo.x - 0.5;
            boxOnePartThree.x = boxOnePartThree.x - 0.5;
            boxTwoPartOne.x = boxTwoPartOne.x - 0.5;
            boxTwoPartTwo.x = boxTwoPartTwo.x - 0.5;
            boxTwoPartThree.x = boxTwoPartThree.x - 0.5;
            boxThree.x = boxThree.x - 0.5;
            boxFourPartOne.x = boxFourPartOne.x - 0.5;
            boxFourPartTwo.x = boxFourPartTwo.x - 0.5;
            boxFourPartThree.x = boxFourPartThree.x - 0.5;
            boxFivePartOne.x = boxFivePartOne.x - 0.5;
            boxFivePartTwo.x = boxFivePartTwo.x - 0.5;
            boxFivePartThree.x = boxFivePartThree.x - 0.5;
            boxSixPartOne.x = boxSixPartOne.x - 0.5;
            boxSixPartTwo.x = boxSixPartTwo.x - 0.5;
            boxSixPartThree.x = boxSixPartThree.x - 0.5;
            boxSevenPartOne.x = boxSevenPartOne.x - 0.5;
            boxSevenPartTwo.x = boxSevenPartTwo.x - 0.5;
            boxSevenPartThree.x = boxSevenPartThree.x - 0.5;
            boxEight.x = boxEight.x - 0.5;
            boxNine.x = boxNine.x - 0.5;
            
            lineOnePartOne.x = lineOnePartOne.x - 0.5;
            lineOnePartTwo.x = lineOnePartTwo.x - 0.5;
            lineOnePartThree.x = lineOnePartThree.x - 0.5;
            lineTwoPartOne.x = lineTwoPartOne.x - 0.5;
            lineTwoPartTwo.x = lineTwoPartTwo.x - 0.5;
            lineTwoPartThree.x = lineTwoPartThree.x - 0.5;
            lineThreePartOne.x = lineThreePartOne.x - 0.5;
            lineThreePartTwo.x = lineThreePartTwo.x - 0.5;
            lineThreePartThree.x = lineThreePartThree.x - 0.5;
            lineFourPartOne.x = lineFourPartOne.x - 0.5;
            lineFourPartTwo.x = lineFourPartTwo.x - 0.5;
            lineFourPartThree.x = lineFourPartThree.x - 0.5;
            lineFivePartOne.x = lineFivePartOne.x - 0.5;
            lineFivePartTwo.x = lineFivePartTwo.x - 0.5;
            lineFivePartThree.x = lineFivePartThree.x - 0.5;
            lineFivePartFour.x = lineFivePartFour.x - 0.5;
            lineFivePartFive.x = lineFivePartFive.x - 0.5;
            lineSixPartOne.x = lineSixPartOne.x - 0.5;
            lineSixPartTwo.x = lineSixPartTwo.x - 0.5;
            lineSixPartThree.x = lineSixPartThree.x - 0.5;
            lineSeven.x = lineSeven.x - 0.5;
            lineEight.x = lineEight.x - 0.5;
            lineNinePartOne.x = lineNinePartOne.x - 0.5;
            lineNinePartTwo.x = lineNinePartTwo.x - 0.5;
            lineNinePartThree.x = lineNinePartThree.x - 0.5;
            lineTenPartOne.x = lineTenPartOne.x - 0.5;
            lineTenPartTwo.x = lineTenPartTwo.x - 0.5;
            lineTenPartThree.x = lineTenPartThree.x - 0.5;
            lineEleven.x = lineEleven.x - 0.5;
            lineTwelvePartOne.x = lineTwelvePartOne.x - 0.5;
            lineTwelvePartTwo.x = lineTwelvePartTwo.x - 0.5;
            lineTwelvePartThree.x = lineTwelvePartThree.x - 0.5;
            lineThirteenPartOne.x = lineThirteenPartOne.x - 0.5;
            lineThirteenPartTwo.x = lineThirteenPartTwo.x - 0.5;
            lineThirteenPartThree.x = lineThirteenPartThree.x - 0.5;
            lineFourteenPartOne.x = lineFourteenPartOne.x - 0.5;
            lineFourteenPartTwo.x = lineFourteenPartTwo.x - 0.5;
            lineFourteenPartThree.x = lineFourteenPartThree.x - 0.5;
            lineFifteenPartOne.x = lineFifteenPartOne.x - 0.5;
            lineFifteenPartTwo.x = lineFifteenPartTwo.x - 0.5;
            lineFifteenPartThree.x = lineFifteenPartThree.x - 0.5;
            line16PartOne.x = line16PartOne.x - 0.5;
            line16PartTwo.x = line16PartTwo.x - 0.5;
            line16PartThree.x = line16PartThree.x - 0.5;
            line17PartOne.x = line17PartOne.x - 0.5;
            line17PartTwo.x = line17PartTwo.x - 0.5;
            line17PartThree.x = line17PartThree.x - 0.5;
            line18PartOne.x = line18PartOne.x - 0.5;
            line18PartTwo.x = line18PartTwo.x - 0.5;
            line18PartThree.x = line18PartThree.x - 0.5;
            line19PartOne.x = line19PartOne.x - 0.5;
            line19PartTwo.x = line19PartTwo.x - 0.5;
            line19PartThree.x = line19PartThree.x - 0.5;
            lineTwentyPartOne.x = lineTwentyPartOne.x - 0.5;
            lineTwentyPartTwo.x = lineTwentyPartTwo.x - 0.5;
            lineTwentyPartThree.x = lineTwentyPartThree.x - 0.5;
            lineTwentyOne.x = lineTwentyOne.x - 0.5;
            lineTwentyTwo.x = lineTwentyTwo.x - 0.5;
            lineTwentyThree.x = lineTwentyThree.x - 0.5;
            
            slotOneBorder.x = slotOneBorder.x - 0.5;
            slotOnePort.x = slotOnePort.x - 0.5;
            slotTwoBorder.x = slotTwoBorder.x - 0.5;
            slotTwoPort.x = slotTwoPort.x - 0.5;
            slotThreeBorder.x = slotThreeBorder.x - 0.5;
            slotThreePort.x = slotThreePort.x - 0.5;
            slotFourBorder.x = slotFourBorder.x - 0.5;
            slotFourPort.x = slotFourPort.x - 0.5;
            slotFiveBorder.x = slotFiveBorder.x - 0.5;
            slotFivePort.x = slotFivePort.x - 0.5;
            slotSixBorder.x = slotSixBorder.x - 0.5;
            slotSixPort.x = slotSixPort.x - 0.5;
            slotSevenBorder.x = slotSevenBorder.x - 0.5;
            slotSevenPort.x = slotSevenPort.x - 0.5;
            slotEightBorder.x = slotEightBorder.x - 0.5;
            slotEightPort.x = slotEightPort.x - 0.5;
            slotNineBorder.x = slotNineBorder.x - 0.5;
            slotNinePort.x = slotNinePort.x - 0.5;
            slotTenBorder.x = slotTenBorder.x - 0.5;
            slotTenPort.x = slotTenPort.x - 0.5;
            slotElevenBorder.x = slotElevenBorder.x - 0.5;
            slotElevenPort.x = slotElevenPort.x - 0.5;
            
            ramSlotOne.x = ramSlotOne.x - 0.5;
            ramPortOne.x = ramPortOne.x - 0.5;
            ramSlotTwo.x = ramSlotTwo.x - 0.5;
            ramPortTwo.x = ramPortTwo.x - 0.5;
